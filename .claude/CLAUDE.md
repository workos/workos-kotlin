# WorkOS Kotlin SDK — Agent Context
...
| [workos/oagen-emitters](https://github.com/workos/oagen-emitters) | The per-language emitters, including the Kotlin emitter that produces this repo's code |

Regeneration runs from a checkout of `openapi-spec`, never from this repo:

```bash
npm run sdk:generate -- --lang kotlin --output workos-kotlin
```
...
| Generated Kotlin code is broken or un-idiomatic | [workos/oagen-emitters](https://github.com/workos/oagen-emitters) |
