* [#388](https://github.com/workos/workos-kotlin/pull/388) feat(generated)!: regenerate from spec (13 changes)
  ...
  * **audit_logs:** Rename AuditLog model classes and update references
    ...
    * Updated all references to these types throughout the codebase
  ...
  * **vault:** Add new Vault service with key encryption and object storage operations
    * New service `Vault` providing data encryption and object storage capabilities
  ...
  * **generated:** Add new Vault data models and event types
    ...
    * New Vault-related models: `Object`, `ObjectMetadata`, `ObjectSummary`, `ObjectVersion`, `ObjectWithoutValue`
    * New general models: `Actor`, `Error`
