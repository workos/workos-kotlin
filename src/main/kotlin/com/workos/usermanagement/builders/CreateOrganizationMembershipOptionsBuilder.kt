 ...
 */
class CreateOrganizationMembershipOptionsBuilder
  @JvmOverloads
  constructor(
    ...
    companion object {
      ...
      ): CreateOrganizationMembershipOptionsBuilder = CreateOrganizationMembershipOptionsBuilder(userId, organizationId)
      ...
      fun create(
        ...
        organizationId: String,
        roleSlug: String
      ): CreateOrganizationMembershipOptionsBuilder = CreateOrganizationMembershipOptionsBuilder(userId, organizationId, roleSlug)
      ...
      ): CreateOrganizationMembershipOptionsBuilder = CreateOrganizationMembershipOptionsBuilder(userId, organizationId, null, roleSlugs)
    }
  }
