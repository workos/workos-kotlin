 ...
 */
class EnrolledAuthenticationFactorOptionsBuilder
  @JvmOverloads
  constructor(
    ...
    fun build(): EnrolledAuthenticationFactorOptions =
      EnrolledAuthenticationFactorOptions(
        type = "totp",
    ...
    companion object {
      @JvmStatic
      fun create(): EnrolledAuthenticationFactorOptionsBuilder = EnrolledAuthenticationFactorOptionsBuilder()
    }
  }
