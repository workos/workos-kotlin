 ...
 */
class UpdateOrganizationMembershipOptionsBuilder
  @JvmOverloads
  constructor(
    ...
    companion object {
      @JvmStatic
      fun create(id: String): UpdateOrganizationMembershipOptionsBuilder = UpdateOrganizationMembershipOptionsBuilder(id)

      @JvmStatic
      fun create(
        id: String,
        roleSlug: String
      ): UpdateOrganizationMembershipOptionsBuilder = UpdateOrganizationMembershipOptionsBuilder(id, roleSlug)

      @JvmStatic
      fun create(
        id: String,
        roleSlugs: List<String>
      ): UpdateOrganizationMembershipOptionsBuilder = UpdateOrganizationMembershipOptionsBuilder(id, null, roleSlugs)
    }
  }
