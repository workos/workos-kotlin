...
class UserManagementApi(
  ...
  fun getUser(userId: String): User = workos.get("/user_management/users/$userId", User::class.java)
  ...
  fun getUserIdentities(userId: String): Array<Identity> =
    workos.get("/user_management/users/$userId/identities", Array<Identity>::class.java)
  ...
  fun getAuthorizationUrl(
    clientId: String,
    redirectUri: String
  ): AuthorizationUrlOptionsBuilder = AuthorizationUrlOptionsBuilder.create(workos.baseUrl, clientId, redirectUri)
  ...
  fun authenticateWithCode(
    ...
    workos.post(
      ...
      RequestConfig
        .builder()
        .data(
          AuthenticationWithCodeOptionsBuilder
            .create(clientId, workos.apiKey, code, options)
            .build()
        ).build()
    )
  ...
  fun authenticateWithPassword(
    ...
    workos.post(
      ...
      RequestConfig
        .builder()
        .data(
          AuthenticationWithPasswordOptionsBuilder
            .create(
              clientId,
              workos.apiKey,
              email,
  ...
  fun authenticateWithMagicAuth(
    ...
    workos.post(
      ...
      RequestConfig
        .builder()
        .data(
          AuthenticationWithMagicAuthOptionsBuilder
            .create(
              clientId,
              workos.apiKey,
              email,
  ...
  fun getJwksUrl(clientId: String): String = URIBuilder(workos.baseUrl).setPath("/sso/jwks/$clientId").toString()

  /** Get the details of an existing Magic Auth code. */
  fun getMagicAuth(id: String): MagicAuth = workos.get("/user_management/magic_auth/$id", MagicAuth::class.java)
  ...
  fun getEmailVerification(id: String): EmailVerification =
    workos.get("/user_management/email_verification/$id", EmailVerification::class.java)

  /** Get the details of an existing password reset token. */
  fun getPasswordReset(id: String): PasswordReset = workos.get("/user_management/password_reset/$id", PasswordReset::class.java)
  ...
  fun getInvitation(id: String): Invitation = workos.get("/user_management/invitations/$id", Invitation::class.java)

  /** Find an existing invitation by token. */
  fun findInvitationByToken(token: String): Invitation = workos.get("/user_management/invitations/by_token/$token", Invitation::class.java)
  ...
  fun revokeInvitation(id: String): Invitation = workos.post("/user_management/invitations/$id/revoke", Invitation::class.java)

  /** Resends an existing invitation. */
  fun resendInvitation(id: String): Invitation = workos.post("/user_management/invitations/$id/resend", Invitation::class.java)
