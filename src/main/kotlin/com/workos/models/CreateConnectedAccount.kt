...
import com.workos.types.CreateConnectedAccountState
import java.time.OffsetDateTime

/** CreateConnectedAccount model. */
data class CreateConnectedAccount(
  ...
  @JsonProperty("state")
  val state: CreateConnectedAccountState? = null,
