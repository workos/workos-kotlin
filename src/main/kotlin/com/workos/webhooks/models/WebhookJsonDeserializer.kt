...
class WebhookJsonDeserializer : JsonDeserializer<WebhookEvent>() {
  ...
  override fun deserialize(
    ...
    return when (eventType) {
      ...
      EventType.AuthenticationEmailVerificationFailed ->
        AuthenticationEvent(
          id,
          eventType,
          deserializeData(data, AuthenticationEventData::class.java),
          createdAt
        )
      EventType.AuthenticationEmailVerificationSucceeded ->
        AuthenticationEvent(
          id,
          eventType,
          deserializeData(data, AuthenticationEventData::class.java),
      ...
      EventType.AuthenticationMagicAuthFailed ->
        AuthenticationEvent(
          id,
          eventType,
          deserializeData(data, AuthenticationEventData::class.java),
      ...
      EventType.AuthenticationMagicAuthSucceeded ->
        AuthenticationEvent(
          id,
          eventType,
          deserializeData(data, AuthenticationEventData::class.java),
      ...
      EventType.AuthenticationMfaFailed ->
        AuthenticationEvent(
          id,
          eventType,
          deserializeData(data, AuthenticationEventData::class.java),
      ...
      EventType.AuthenticationMfaSucceeded ->
        AuthenticationEvent(
          id,
          eventType,
          deserializeData(data, AuthenticationEventData::class.java),
      ...
      EventType.AuthenticationOauthFailed ->
        AuthenticationEvent(
          id,
          eventType,
          deserializeData(data, AuthenticationEventData::class.java),
      ...
      EventType.AuthenticationOauthSucceeded ->
        AuthenticationEvent(
          id,
          eventType,
          deserializeData(data, AuthenticationEventData::class.java),
      ...
      EventType.AuthenticationPasskeyFailed ->
        AuthenticationEvent(
          id,
          eventType,
          deserializeData(data, AuthenticationEventData::class.java),
      ...
      EventType.AuthenticationPasskeySucceeded ->
        AuthenticationEvent(
          id,
          eventType,
          deserializeData(data, AuthenticationEventData::class.java),
      ...
      EventType.AuthenticationPasswordFailed ->
        AuthenticationEvent(
          id,
          eventType,
          deserializeData(data, AuthenticationEventData::class.java),
      ...
      EventType.AuthenticationPasswordSucceeded ->
        AuthenticationEvent(
          id,
          eventType,
          deserializeData(data, AuthenticationEventData::class.java),
      ...
      EventType.AuthenticationRadarRiskDetected ->
        RadarRiskDetectedEvent(
          id,
          eventType,
          deserializeData(data, RadarRiskDetectedEventData::class.java),
          createdAt
        )
      EventType.AuthenticationSsoFailed ->
        AuthenticationEvent(
          id,
          eventType,
          deserializeData(data, AuthenticationEventData::class.java),
      ...
      EventType.AuthenticationSsoStarted ->
        AuthenticationEvent(
          id,
          eventType,
          deserializeData(data, AuthenticationEventData::class.java),
      ...
      EventType.AuthenticationSsoSucceeded ->
        AuthenticationEvent(
          id,
          eventType,
          deserializeData(data, AuthenticationEventData::class.java),
      ...
      EventType.AuthenticationSsoTimedOut ->
        AuthenticationEvent(
          id,
          eventType,
          deserializeData(data, AuthenticationEventData::class.java),
      ...
      EventType.ConnectionSamlCertificateRenewalRequired ->
        ConnectionSamlCertificateRenewalRequiredEvent(
          id,
          eventType,
          deserializeData(data, SamlCertificateRenewalRequiredEventData::class.java),
          createdAt
        )
      EventType.ConnectionSamlCertificateRenewed ->
        ConnectionSamlCertificateRenewedEvent(
          id,
          eventType,
          deserializeData(data, SamlCertificateRenewedEventData::class.java),
          createdAt
        )
      ...
      EventType.DirectoryGroupUpdated ->
        DirectoryGroupUpdatedEvent(
          id,
          eventType,
          deserializeData(data, GroupUpdated::class.java),
          createdAt
        )
      EventType.DirectoryGroupDeleted -> DirectoryGroupDeletedEvent(id, eventType, deserializeData(data, Group::class.java), createdAt)
      EventType.DirectoryGroupUserAdded ->
        DirectoryGroupUserAddedEvent(
          id,
          eventType,
          deserializeData(data, DirectoryGroupUserEvent::class.java),
          createdAt
        )
      EventType.DirectoryGroupUserRemoved ->
        DirectoryGroupUserRemovedEvent(
          id,
          eventType,
          deserializeData(data, DirectoryGroupUserEvent::class.java),
          createdAt
      ...
      EventType.EmailVerificationCreated ->
        EmailVerificationEvent(
          id,
          eventType,
          deserializeData(data, EmailVerificationEventData::class.java),
          createdAt
        )
      ...
      EventType.OrganizationDomainCreated ->
        OrganizationDomainEvent(
          id,
          eventType,
          deserializeData(data, OrganizationDomain::class.java),
          createdAt
        )
      EventType.OrganizationDomainDeleted ->
        OrganizationDomainEvent(
          id,
          eventType,
          deserializeData(data, OrganizationDomain::class.java),
      ...
      EventType.OrganizationDomainUpdated ->
        OrganizationDomainEvent(
          id,
          eventType,
          deserializeData(data, OrganizationDomain::class.java),
      ...
      EventType.OrganizationDomainVerificationFailed ->
        OrganizationDomainEvent(
          id,
          eventType,
          deserializeData(data, OrganizationDomain::class.java),
      ...
      EventType.OrganizationDomainVerified ->
        OrganizationDomainEvent(
          id,
          eventType,
          deserializeData(data, OrganizationDomain::class.java),
      ...
      EventType.OrganizationMembershipCreated ->
        OrganizationMembershipEvent(
          id,
          eventType,
          deserializeData(data, OrganizationMembership::class.java),
          createdAt
        )
      EventType.OrganizationMembershipDeleted ->
        OrganizationMembershipEvent(
          id,
          eventType,
          deserializeData(data, OrganizationMembership::class.java),
      ...
      EventType.OrganizationMembershipUpdated ->
        OrganizationMembershipEvent(
          id,
          eventType,
          deserializeData(data, OrganizationMembership::class.java),
      ...
      EventType.OrganizationRoleCreated ->
        OrganizationRoleWebhookEvent(
          id,
          eventType,
          deserializeData(data, OrganizationRoleEventData::class.java),
          createdAt
        )
      EventType.OrganizationRoleDeleted ->
        OrganizationRoleWebhookEvent(
          id,
          eventType,
          deserializeData(data, OrganizationRoleEventData::class.java),
      ...
      EventType.OrganizationRoleUpdated ->
        OrganizationRoleWebhookEvent(
          id,
          eventType,
          deserializeData(data, OrganizationRoleEventData::class.java),
      ...
      EventType.PasswordResetCreated ->
        PasswordResetEvent(
          id,
          eventType,
          deserializeData(data, PasswordResetEventData::class.java),
          createdAt
        )
      EventType.PasswordResetSucceeded ->
        PasswordResetEvent(
          id,
          eventType,
          deserializeData(data, PasswordResetEventData::class.java),
      ...
      EventType.PermissionCreated ->
        PermissionWebhookEvent(
          id,
          eventType,
          deserializeData(data, PermissionEventData::class.java),
          createdAt
        )
  ...
  private fun <T> deserializeData(
    data: TreeNode?,
    clazz: Class<T>
  ): T = mapper.treeToValue(data, clazz)
}
