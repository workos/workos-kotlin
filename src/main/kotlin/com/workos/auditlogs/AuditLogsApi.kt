...
class AuditLogsApi(
   ...
   */
  @JsonInclude(Include.NON_NULL)
  class CreateAuditLogEventOptions
    @JvmOverloads
    constructor(
      val action: String,
      ...
      companion object {
        @JvmStatic
        fun builder(): CreateAuditLogEventOptionsBuilder = CreateAuditLogEventOptionsBuilder()
      }
    }
  ...
  class CreateAuditLogEventRequestOptions constructor(
    ...
    companion object {
      @JvmStatic
      fun builder(): CreateAuditLogEventRequestOptionsBuilder = CreateAuditLogEventRequestOptionsBuilder()
    }
  }
   ...
   */
  @JsonInclude(Include.NON_NULL)
  class CreateAuditLogExportOptions
    @JvmOverloads
    constructor(
      ...
      companion object {
        @JvmStatic
        fun builder(): CreateAuditLogExportOptionsBuilder = CreateAuditLogExportOptionsBuilder()
      }
    }
   ...
   */
  fun getExport(auditLogExportId: String): AuditLogExport = workos.get("/audit_logs/exports/$auditLogExportId", AuditLogExport::class.java)
}
