...
class SsoApi(
   ...
   */
  class AuthorizationUrlOptionsBuilder
    @JvmOverloads
    constructor(
      val baseUrl: String,
      val clientId: String,
      ...
      companion object {
        ...
        fun create(
          ...
          clientId: String,
          redirectUri: String
        ): AuthorizationUrlOptionsBuilder = AuthorizationUrlOptionsBuilder(baseUrl, clientId, redirectUri)
      }
    }
   ...
   */
  fun getConnection(id: String): Connection = workos.get("/connections/$id", Connection::class.java)
  ...
  class ListConnectionsOptions
    ...
    constructor(
      ...
      companion object {
        @JvmStatic
        fun builder(): ListConnectionsOptionsPaginationParamsBuilder = ListConnectionsOptionsPaginationParamsBuilder()
      }

      /**
       * Parameters builder for [listConnections] method.
       */
      class ListConnectionsOptionsPaginationParamsBuilder :
        PaginationParams.PaginationParamsBuilder<ListConnectionsOptions>(ListConnectionsOptions()) {
        /**
