...
class DirectorySyncApiTest : TestBase() {
  ...
  fun listDirectoriesWithNoParamsShouldReturnDirectories() {
    ...
    assertEquals(oktaDirectory.type, DirectoryType.OktaScimV20)
  }
  ...
  fun listDirectoriesWithParamsShouldReturnDirectories() {
    ...
    val paginationParams =
      DirectorySyncApi.ListDirectoriesOptions
        .builder()
        .after("someAfterId")
        .before("someBeforeId")
        .limit((1))
  ...
  fun listDirectoryGroupsWithUserParamShouldReturnDirectoryGroups() {
    ...
    val listOptions =
      DirectorySyncApi.ListDirectoryGroupOptions
        .builder()
        .user(userId)
        .build()
